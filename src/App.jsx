...
const APP_VERSION = "Castan Realtime v2.5.0-bloqueio-agenda-chave";
                ...
                {agendaBloqueios
                  ...
                  .map(b=>
                    <div key={b.id} className="bloqueio-card">
                      <strong>{brDate(b.data_bloqueio)} • {String(b.horario_inicio||"").slice(0,5)} às {String(b.horario_fim||"").slice(0,5)}</strong>
                      <p>{b.justificativa}</p>
