...
const APP_VERSION = "Castan Realtime v3.0.1-horario-brasil";
...
const visitasCanceladasBase=visitas
  ...
  function exportReport(){
    ...
    acoes.filter(a=>{const d=visitas.find(x=>x.id===a.visita_id)?.data_visita; return d>=reportStart && d<=reportEnd;}).forEach(a=>{
