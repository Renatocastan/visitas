...
const APP_VERSION = "Castan Realtime v3.0.5-hora-brasil-notificacoes";
...
const brFixedDate = v => new Date((v ? new Date(v).getTime() : Date.now()) - BR_OFFSET_MS);
const pad2 = v => String(v).padStart(2,"0");
const brDateTime = v => {
  if(!v) return "";
  const d = brFixedDate(v);
