...
const APP_VERSION = "Castan Realtime v2.1.2-logo-canceladas-calendario";
  ...
  return <div className="app" onTouchStart={e=>{touchStart.current=e.touches[0].clientY}} onTouchEnd={e=>{const end=e.changedTouches[0].clientY;if(window.scrollY===0&&end-touchStart.current>80)loadAll()}}>
    ...
    <header className="header">
      ...
      <div className="header-logo-wrap">
        <img src="/logo-castan-agenda.jpeg" alt="Castan Agenda de Visitas" className="header-logo"/>
      </div>
      ...
      <>
        <nav className="tabs">
          {[
            ...
            ["minha_agenda",CalendarDays,"Minha agenda"],["canceladas",ListChecks,"Canceladas"],["lista",ListChecks,"Lista"],
