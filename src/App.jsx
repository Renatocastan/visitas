...
const APP_VERSION = "Castan Realtime v3.1.7-seg-sab-08-18";
...
function WeeklyCalendar({weekStart,visitas,bloqueios=[],colorForUser,getUser,onNew,onEdit}){
  ...
  const days=Array.from({length:6}).map((_,i)=>{
    ...
    const offset=startDay===0?1-startDay:1-startDay;
    d.setDate(weekStart.getDate()+offset+i);
    return d;
  });
  ...
  return <div className="week-scheduler week-scheduler-list no-sunday-calendar" onMouseLeave={()=>setTooltip(null)}>
