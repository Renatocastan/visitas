...
const APP_VERSION = "Castan Realtime v1.9.1-painel-admin-corrigido";
...
export default function App(){
  ...
  const canDeleteVisits = isAdmin || hasPerm("excluir_visita", false);
  ...
  return <div className="overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
    <div className="modal">
      ...
      <div className="form">
        ...
        <Select label="Status *" value={f.status} disabled={limited} onChange={v=>setF({...f,status:v})} options={statusOptions}/>
