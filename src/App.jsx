...
const APP_VERSION = "Castan Realtime v3.2.5-central-operacional";
...
function CentralOperacional({visitasHoje,ativas,concluidas,canceladas,reservas,fotos,emAndamento,proxima,proximas,getUser,lastSync,tvMode,onModoTV,onSairTV,onOpenVisit}){
