...
const APP_VERSION = "Castan Realtime v2.2.0-canceladas-logo-definitivo";
...
function CanceladasView({
  ...
  const base = visitas
    .filter(v=>v.status==="cancelada")
    .sort((a,b)=>
      (String(b.data_visita||"")+String(b.horario_visita||""))
        .localeCompare(String(a.data_visita||"")+String(a.horario_visita||""))
    );
